							...
							$token_hash = $this->security->get_csrf_hash();
		                   	 foreach ($barang AS $brg) { ?>
		                   		<div class="col-sm-4 mt-2">
			                   		<div class="card">
			                   		<input type="hidden" class="id" name="idPesan" value="<?php echo $brg['id_barang'] ?>">
									  ...
									  <div class="card-body">
									    ...
									    <input class="qty" type="number" name="qty" value="1" min="1" id="<?php echo $brg['id_barang'] ?>"><?php echo form_error('qty', '<p class="text-danger">', '</p>'); ?>
									    <br/><br/>
